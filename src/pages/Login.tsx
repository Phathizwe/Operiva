...
export default function Login() {
  ...
  // Preload Dashboard component after login page loads
  useEffect(() => {
    const preloadDashboard = () => {
      // This import statement will trigger webpack to load the chunk
      import('../pages/Dashboard');
      // Also preload Home page as users might navigate there
      import('../pages/Home');
    };
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="block w-full appearance-none rounded-md border border-gray-300 dark:border-gray-600 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white sm:text-sm"
                />
              </div>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                disabled={isSubmitting}
                className="flex w-full justify-center items-center gap-3 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 py-2 px-4 text-sm font-medium text-gray-700 dark:text-white shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-75 disabled:cursor-not-allowed"
              >
