...
const artifacts = [
  ...
  { id: 'a1', title: 'VAT-Aware Invoice Template Pack', description: 'Create professional, VAT-compliant invoices that get paid faster.', outcome: 'Cash', type: 'Template', version: 'v1.2', lastUpdated: new Date(), downloadUrl: 'https://files.manuscdn.com/user_upload_by_module/session_file/116270498/atDEJoMwnZJeUAaM.zip', fileType: 'ZIP', isPremium: false , previewImageUrl: '/images/previews/vat-invoice-template.png'},
